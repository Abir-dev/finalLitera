...
const RealTimeDashboard = () => {
  ...
  const getActivityIcon = (iconType) => {
    switch (iconType) {
      case "user":
        return <Users size={20} style={{ color: "var(--brand)" }} />;
      case "book":
        return <BookOpen size={20} style={{ color: "var(--accent-gold)" }} />;
      case "exam":
        return <FileText size={20} style={{ color: "var(--accent-rose)" }} />;
      case "payment":
        return (
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-3 sm:gap-4">
            <div className="space-y-1 sm:space-y-2">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div>
                  <h1
                    className="heading-1 text-2xl lg:text-3xl"
              ...
              <p
                className="text-sm lg:text-base flex items-center gap-2"
                style={{ color: "var(--text-secondary)" }}
              >
                <Clock size={16} />
                Live data from your database • Last updated:{" "}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
        <div className="group card-premium dashboard-stat-card p-6 hover:scale-[1.02] transition-all duration-500 relative overflow-hidden">
          ...
          <div className="relative flex items-center justify-between">
            ...
            <div
              className="w-12 h-12 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-500"
              style={{
                background:
        ...
        <div className="group card-premium dashboard-stat-card p-6 hover:scale-[1.02] transition-all duration-500 relative overflow-hidden">
          ...
          <div className="relative flex items-center justify-between">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, var(--brand-strong), var(--accent-emerald))",
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className="card-premium dashboard-course-card p-6 h-full">
          ...
          <div className="space-y-4 flex-1 overflow-y-auto custom-scrollbar">
            {dashboardData.topCourses.map((course, index) => (
              <div
                key={course.id}
                className="group relative card-premium p-4 hover:scale-[1.02] transition-all duration-300"
              >
                <div
                  className="absolute top-3 left-3 w-6 h-6 rounded-lg flex items-center justify-center text-white font-bold text-xs shadow-lg"
                  style={{
                    background:
                      index === 0
                        ? "linear-gradient(135deg, var(--accent-gold), var(--accent-gold-strong))"
                ...
                <div className="ml-8">
                  <div className="flex items-start justify-between mb-3">
                    <h3
                      className="font-bold text-sm leading-snug pr-2"
                      style={{ color: "var(--text-primary)" }}
                    >
                      {course.name || "Untitled Course"}
                    </h3>
                    <div
                      className="flex items-center gap-1 px-2 py-1 rounded-lg shadow-lg"
                      style={{
                        background:
      ...
      <div className="card-premium p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
          {dashboardData.studentProgress.map((course, index) => (
            <div
              key={index}
              className="group card-premium dashboard-progress-card p-4 hover:scale-[1.02] transition-all duration-300 relative overflow-hidden"
            >
              <div
                className="absolute top-0 right-0 w-16 h-16 rounded-full opacity-10 -mr-8 -mt-8"
                style={{
                  background:
                    index % 4 === 0
                      ? "var(--brand)"
                    ...
                    >
                      <div
                        ...
                        style={{
                          ...
                          background:
                            "linear-gradient(90deg, var(--accent-gold), var(--accent-gold-strong))",
                        }}
                      />
                    </div>
                  </div>
      ...
      <div className="card-premium p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <Link
            to="/admin/students"
            className="group card-premium dashboard-action-card p-4 hover:scale-[1.05] transition-all duration-300 relative overflow-hidden"
          >
            <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 to-purple-600/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            <div className="relative">
              <div
                className="w-12 h-12 rounded-xl flex items-center justify-center mx-auto mb-3 shadow-xl group-hover:scale-110 transition-transform duration-300"
                style={{
                  background:
                    "linear-gradient(135deg, var(--brand), var(--brand-strong))",
                  border: "1px solid var(--brand)30",
