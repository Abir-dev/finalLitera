    ...
    if (sortBy !== "default") {
      filtered.sort((a, b) => {
        switch (sortBy) {
          ...
          case "rating-desc":
            return (
              (b.rating?.average || b.rating || 0) -
              (a.rating?.average || a.rating || 0)
            );
          case "students-desc":
            return (
              (b.enrollmentCount || b.students || 0) -
              (a.enrollmentCount || a.students || 0)
            );
          default:
            return 0;
        }
  ...
  return (
    <div>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20">
        ...
        <div className="card-premium p-4 mb-6 bg-gradient-to-r from-blue-500/10 to-purple-500/10 border-2 border-blue-500/30">
          {/* Compact Search Row */}
        ...
        <section className="mb-6 sm:mb-8">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
            <div className="card-premium p-3 text-center group hover:scale-105 transition-all duration-300 bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-600/30">
              <div
