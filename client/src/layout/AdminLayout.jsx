...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--bg-primary)" }}>
      ...
      <div
        className={`fixed inset-y-0 left-0 z-50 w-64 sm:w-72 transform transition-all duration-500 ease-in-out ${
      ...
      >
        ...
        >
          ...
          <div
            className="px-3 sm:px-6 py-4 sm:py-6 border-b"
          ...
          >
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p
                  className="text-xs sm:text-sm capitalize font-medium truncate"
            ...
            {navigation.map((item) => {
              ...
              return (
                <Link
                  ...
                  style={
                    isActive
                      ? {
                          background:
                            "linear-gradient(135deg, var(--brand)60, var(--brand-strong)80)",
                ...
                >
                  ...
                  <span className="flex-1 relative hidden sm:block">
                    {item.name}
                  </span>
                  <span className="flex-1 relative sm:hidden text-xs truncate">
                    {item.name.split(" ")[0]}
                  </span>
                  {isActive && (
          ...
          >
            ...
            >
              ...
              <LogOut
                size={16}
                className="sm:w-[18px] sm:h-[18px] text-white relative group-hover:rotate-12 transition-transform duration-300"
              />
      ...
      <div className="lg:pl-72">
        ...
        <main
          className="p-3 sm:p-6 container-premium min-h-screen transition-all duration-300 ease-in-out"
